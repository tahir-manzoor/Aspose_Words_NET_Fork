...
namespace ApiExamples
{
    ...
    internal class ExHtmlSaveOptions : ApiExampleBase
    {
            ...
            switch (saveFormat)
            {
                case SaveFormat.Html:
                    DocumentHelper.FindTextInFile(
                        ...
                        "<img src=\"HtmlSaveOptions.ExportToHtmlUsingImage.001.png\" width=\"49\" height=\"21\" alt=\"\" style=\"-aw-left-pos:0pt; -aw-rel-hpos:column; -aw-rel-vpos:paragraph; -aw-top-pos:0pt; -aw-wrap-type:inline\" />");
                    return;
        ...
        public void ExportTextBoxAsSvg(SaveFormat saveFormat, bool textBoxAsSvg)
        {
            ...
            switch (saveFormat)
            {
                ...
                case SaveFormat.Mhtml:
                    ...
                    DocumentHelper.FindTextInFile(
                        MyDir + @"\Artifacts\ExportTextBoxAsSvg." + saveFormat.ToString().ToLower(),
                        "<img src=\"ExportTextBoxAsSvg.001.png\" width=\"240\" height=\"118\" alt=\"\" style=\"margin:3.22pt 9pt 3.6pt 8.62pt; -aw-left-pos:0pt; -aw-rel-hpos:column; -aw-rel-vpos:paragraph; -aw-top-pos:14.4pt; -aw-wrap-type:square; float:left\" />");
                    return;
            }
        }
        ...
        private static Document Save(Document inputDoc, string outputDocPath, SaveFormat saveFormat,
        ...
        {
            var doc = new Document(MyDir + "ExportUrlForLinkedImage.docx");
            ...
            var dirFiles = Directory.GetFiles(MyDir + @"\Artifacts\", "ExportUrlForLinkedImage.001.png",
                SearchOption.AllDirectories);

            if (dirFiles.Length == 0)
                DocumentHelper.FindTextInFile(MyDir + @"\Artifacts\ExportUrlForLinkedImage.html",
                    "<img src=\"http://www.aspose.com/images/aspose-logo.gif\"");
            else
                DocumentHelper.FindTextInFile(MyDir + @"\Artifacts\ExportUrlForLinkedImage.html",
                    "<img src=\"ExportUrlForLinkedImage.001.png\"");
        }
        ...
        public void ExportRoundtripInformation(bool valueHtml)
        {
            ...
            if (valueHtml)
                DocumentHelper.FindTextInFile(MyDir + @"\Artifacts\HtmlSaveOptions.RoundtripInformation.html",
