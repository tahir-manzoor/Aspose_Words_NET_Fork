...
namespace ApiExamples
{
    ...
    internal class ExHtmlSaveOptions : ApiExampleBase
    {
        ...
        public void ExportTextBoxAsSvg(SaveFormat saveFormat, bool textBoxAsSvg)
        {
            ...
            switch (saveFormat)
            {
                case SaveFormat.Html:
                    ...
                    dirFiles = Directory.GetFiles(MyDir + @"\Artifacts\", "HtmlSaveOptions.ExportTextBoxAsSvg.001.png",
                        SearchOption.AllDirectories);
                    Assert.IsEmpty(dirFiles);

                    DocumentHelper.FindTextInFile(
                        MyDir + @"\Artifacts\HtmlSaveOptions.ExportTextBoxAsSvg." + saveFormat.ToString().ToLower(),
                ...
                case SaveFormat.Mhtml:
                    ...
                    DocumentHelper.FindTextInFile(
                        MyDir + @"\Artifacts\HtmlSaveOptions.ExportTextBoxAsSvg." + saveFormat.ToString().ToLower(),
                        "<img src=\"HtmlSaveOptions.ExportTextBoxAsSvg.001.png\" width=\"240\" height=\"118\" alt=\"\" style=\"margin:3.22pt 9pt 3.6pt 8.62pt; -aw-left-pos:0pt; -aw-rel-hpos:column; -aw-rel-vpos:paragraph; -aw-top-pos:14.4pt; -aw-wrap-type:square; float:left\" />");
                    return;
            }
        }
        ...
        public void ExportUrlForLinkedImage(bool export)
        {
            ...
            var dirFiles = Directory.GetFiles(MyDir + @"\Artifacts\", "HtmlSaveOptions.ExportUrlForLinkedImage.001.png",
                SearchOption.AllDirectories);
